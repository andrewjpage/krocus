...
class TestGene(unittest.TestCase):
    ...
    def test_zero_allele_number(self):
        g = Gene('ABC_0', 10, 0)
        self.assertEqual(g.allele_number(), 0)
        self.assertEqual(g.allele_name(), 'ABC')

    def test_large_allele_number(self):
        g = Gene('ABC_99999', 10, 0)
        self.assertEqual(g.allele_number(), 99999)
        self.assertEqual(g.allele_name(), 'ABC')
